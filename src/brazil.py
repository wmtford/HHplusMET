...
if __name__ == '__main__':
	...
	resultsBoost=[];
	resultsResolv=[]
	resultsResolv.append( ExtractFile(idir+'/HiggsinoResolvedOnlyTChiHH200.Asymptotic.mH200.root','200') );
	resultsResolv.append( ExtractFile(idir+'/HiggsinoResolvedOnlyTChiHH225.Asymptotic.mH225.root','225') );
	resultsResolv.append( ExtractFile(idir+'/HiggsinoResolvedTChiHH250.Asymptotic.mH250.root','250') );
