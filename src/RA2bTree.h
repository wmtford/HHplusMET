...
RA2bTree::RA2bTree(TChain *tree) : fChain(0) {
  if (tree == 0) {
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV18/tree_signal/tree_ZJetsToNuNu_HT-100to200_MC2016.root");
    if (!f || !f->IsOpen()) {
      f = new TFile("/eos/uscms/store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV18/tree_signal/tree_ZJetsToNuNu_HT-100to200_MC2016.root");
    }
