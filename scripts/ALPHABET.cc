...
int main(int argc, char** argv){
  ...
  TString regionName=""; TString cutName=""; TString dataCut = "";
  if (region == 1) regionName = "1DTChiHH_";
  if (region == 1 && runFullSIM) regionName = "1DT5HH_FullSIM_";
  else if (region == 2 && mass2D<810) regionName = "2DTChiHH_"; //for datacards
  else if (region == 2 && mass2D>810) regionName = "2DT5HH_";  //for datacards
  // else if (region == 2) regionName = "2DTChiHH_";
  // else if (region == 2) regionName = "2DT5HH_";
  else if (region == 3) regionName="singleMu_";
  else if (region == 4) regionName="singleEle_";
  else if (region == 5) regionName="photon_";
  if (runVeto) cutName = "resVeto_";
  if (runData) dataCut = "data";
  ...
  for (unsigned int iSample = 0; iSample < skims.ntuples.size(); iSample++) {
    ...
    for (int iEvt = 0; iEvt < numEvents ; iEvt++) {
      ...
      if (doubleTaggingLooseCut(ntuple)) {
        ...
        // h_2H->Fill(fillLeadingJetMass(ntuple),fillSubLeadingJetMass(ntuple),weight);
      } //end 2H
      ...
      //then check for 1H
        ...
        // h_1H->Fill(fillLeadingJetMass(ntuple),fillSubLeadingJetMass(ntuple),weight);
      } //end 1H
      ...
      //then check for 0H
        ...
        if (antitagPlusBCut(ntuple)) for (unsigned int i = 0; i < antitagBTagPlots.size(); i++) antitagBTagPlots[i].fill(ntuple,weight*BSFwt);
        ...
        // h_0H->Fill(fillLeadingJetMass(ntuple),fillSubLeadingJetMass(ntuple),weight);
      } //end 0H region
