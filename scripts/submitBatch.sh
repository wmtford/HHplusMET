...
#outputDir=ALPHABETTest

#Useful for when running signal systematics
# systDir=
testDir=ALPHABETTest
systDir=JECUp #not actually run, just showing capabilities
...
condor_submit batchExecute.jdl exec_name="ALPHABET_1DTChiHH_2016_$vetoOpt_$i_$systDir" arguments="${outputDir} ALPHABET 1 MC2016 $vetoOpt 600"
...
# 2DT5HH (switch bool in skimSamples, probably don't run...)
